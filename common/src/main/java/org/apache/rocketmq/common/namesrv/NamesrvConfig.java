...
public class NamesrvConfig {
    ...
    /** ROCKETMQ_HOME_PROPERTY=rocketmq.home.dir   ROCKETMQ_HOME_ENV=ROCKETMQ_HOME  mqnamesrv脚本有配置ROCKETMQ_HOME */
    private String rocketmqHome = System.getProperty(MixAll.ROCKETMQ_HOME_PROPERTY, System.getenv(MixAll.ROCKETMQ_HOME_ENV)); /** 默认配置路径 假设是root  /root/namesrv/kvConfig.json*/
