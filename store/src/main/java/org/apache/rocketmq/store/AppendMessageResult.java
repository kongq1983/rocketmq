...
public class AppendMessageResult {
    ...
    // Where to start writing 开始写的位置 是真正的物理位置
    ...
    // Consume queue's offset(step by one) 消息的逻辑地址，代表是topic-queueId这个队列中的第几个位置，即下标
    private long logicsOffset;
    private long pagecacheRT = 0;
    // 写入的消息数量，默认是1  只有在处理批量消息MessageExtBatch时，会设置为其他值
