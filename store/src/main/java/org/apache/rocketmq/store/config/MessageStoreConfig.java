...
public class MessageStoreConfig {
    ...
    // ConsumeQueue file size,default is 30W * 20（每条20字节）
    ...
    private String messageDelayLevel = "1s 5s 10s 30s 1m 2m 3m 4m 5m 6m 7m 8m 9m 10m 20m 30m 1h 2h"; // TODO 延迟消息-时间间隔-定义
    ...
    public int getMappedFileSizeConsumeQueue() {
        // mapedFileSizeConsumeQueue=300000  30w    公式=(300000*20)/(20*1) = 300000 = 30w
        int factor = (int) Math.ceil(this.mappedFileSizeConsumeQueue / (ConsumeQueue.CQ_STORE_UNIT_SIZE * 1.0));
        return (int) (factor * ConsumeQueue.CQ_STORE_UNIT_SIZE); // 300000*20 = 600w
    }
